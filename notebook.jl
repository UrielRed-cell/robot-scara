...
#=begin
	...
	ye=WGLMakie.Observable(Float64[0,0,0])
	ax = Axis(fig[1,1],aspect=DataAspect())
	lines!(ax, xe, ye, linewidth=5)
	xlims!(ax,-200,200)
	ylims!(ax,-200,200)
	fig
end=#
...
function draw_arm!(θ,xe,ye)
	if θ==nothing
		return nothing
	end
	E₁=[80*cos(θ[1]),80*sin(θ[1])]
	E₂=[E₁[1]+70*cos(θ[2]+θ[1]),E₁[2]+70*sin(θ[2]+θ[1])]
	xe[]=[0,E₁[1],E₂[1]]
	ye[]=[0,E₁[2],E₂[2]]
	return xe[], ye[]
end
...
git-tree-sha1 = "93c6642f0785e1b0f4785fce8c374c3aac2e0614"
